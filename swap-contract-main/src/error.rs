...
pub enum AmmError {
    ...
    /// The program address provided doesn't match the value generated by the program.
    #[error("Invalid state address generated from seed")]
    InvalidStateAddress,
    
    /// The owner of the input isn't set to the program address generated by the program.
    #[error("Invalid owner of the state account")]
    InvalidStateOwner,
    ...
    /// The pool token mint has a non-zero supply.
    #[error("Pool token mint doesn't have exact decimal")]
    InvalidDecimals,

    
    /// Owner of Market account is incorrect
    #[error("Owner of Market account is incorrect")]
    IncorrectMarketOwnerAccount,

    /// The account cannot be initialized because it is already being used.
    #[error("State owner should be the signer")]
    InvalidSigner,
